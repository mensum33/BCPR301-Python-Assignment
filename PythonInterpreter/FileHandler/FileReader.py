        ...
        if path.endswith('.py'):
            ...
            if valid == 'ok':
                ...
                if Validator.contains_multiple_class(raw_data) is not False:
                    ...
                    has stopped as more than 1\
                    class definition was found in \n' + path)
            elif valid == 'f':
                raw_data = Pep8Formatter.format_pep8(path)
                if Validator.contains_multiple_class(raw_data) is not False:
                    result = raw_data
                else:
                    print('Data Extraction has\
                    stopped as more than 1 class\
            ...
            for file in files:
                if file.endswith('.py'):
                    ...
                    if valid == 'ok':
                        ...
                        if Validator.contains_multiple_class(raw_data) \
                                is not False:
                        ...
                        if Validator.contains_multiple_class(raw_data) \
                            ...
                            print('Data Extraction has stopped as\
                            more than 1 class definition \
                            was found in \n' + file_path)
                            data = []
                            break
                    else:
                        print('Not a valid Python code in ', file_path,
                              ...
                              stopped! Fix the file and try again')
                        data = []
                        break
        return data
